...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, queries, mask = None):
        ...
        # queries/keys/values shape: (N, query_len, heads, heads_dim)
        ...
        # after einsum (N, query_len, head, head_dim) then flatten last two dimention
...
class Transformer(nn.Module):
    ...
    def forward(self, src, trg):
        ...
        trg_mask = self.make_trg_ask(trg)
